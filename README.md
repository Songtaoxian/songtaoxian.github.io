...
- `shaotianxiao@westlake.edu.cn` (example)
...
Create a repository named `<your-github-username>.github.io`, upload these files to the repository root, and enable GitHub Pages from the `main` branch root.
